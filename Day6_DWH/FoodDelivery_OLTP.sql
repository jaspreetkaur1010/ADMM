-- Active: 1771363880763@@127.0.0.1@3306@fooddelivery
...
-- Restaurants
-- ------------
DROP TABLE IF EXISTS fooddelivery.restaurants;
...
CREATE TABLE fooddelivery.food_items (
    ...
    created_at DATETIME(6) DEFAULT CURRENT_TIMESTAMP(6),
    updated_at DATETIME(6) DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
    FOREIGN KEY (restaurant_id) REFERENCES fooddelivery.restaurants(restaurant_id)
);
...
-- Orders
-- --------
DROP TABLE IF EXISTS fooddelivery.orders;
CREATE TABLE fooddelivery.orders (
    ...
    created_at DATETIME(6) DEFAULT CURRENT_TIMESTAMP(6),
    updated_at DATETIME(6) DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
    FOREIGN KEY (customer_id) REFERENCES fooddelivery.customers(customer_id),
    FOREIGN KEY (restaurant_id) REFERENCES fooddelivery.restaurants(restaurant_id),
    FOREIGN KEY (delivery_partner_id) REFERENCES fooddelivery.delivery_partner(partner_id)
);
